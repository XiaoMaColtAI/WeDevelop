package org.example.wedevelop.utils;
...
public class WebScreenshotUtils {
    ...
    private static WebDriver initChromeDriver(int width, int height) {
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "初始化 Chrome 浏览器失败，请确保已安装 Chrome 浏览器和 ChromeDriver");
        }
    }
